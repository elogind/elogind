...
#define VARLINK_ERROR_DISCONNECTED "io.elogind.Disconnected"
#define VARLINK_ERROR_TIMEOUT "io.elogind.TimedOut"
#define VARLINK_ERROR_PROTOCOL "io.elogind.Protocol"
#define VARLINK_ERROR_SYSTEM "io.elogind.System"
