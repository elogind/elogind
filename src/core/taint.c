...
static int short_uid_gid_range(UIDRangeUsernsMode mode) {
        ...
        /* Taint elogind if we the UID range assigned to this environment doesn't at least cover 0…65534,
        /* Taint elogind if we the UID/GID range assigned to this environment doesn't at least cover 0…65534,
