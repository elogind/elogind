...
static enum nss_status nss_elogind_endent(GetentData *p) {
        PROTECT_ERRNO;
        NSS_ENTRYPOINT_BEGIN;
...
#if 1 ///* Aliases for using nss-elogind as a drop-in replacement for nss-systemd
