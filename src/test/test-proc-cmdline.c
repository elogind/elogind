...
TEST(proc_cmdline_filter_pid1_args) {
        test_proc_cmdline_filter_pid1_args_one("elogind\0",
                                               STRV_MAKE_EMPTY);
        ...
        test_proc_cmdline_filter_pid1_args_one("/usr/lib/elogind/elogind\0"
                                               "--switched-root\0"
                                               "--system\0"
                                               ...
                                               "--exit-code=42\0"
                                               "\0\0\0"
                                               "elogind.log_level=debug\0"
                                               "--unit\0foo.target\0"
                                               "  '  quoted '\0"
                                               "elogind.log_target=console\0"
                                               "\t\0"
                                               "  arg   with   space \0"
                                               "3\0"
                                               "\0\0\0",
                                               STRV_MAKE("", "", "", "elogind.log_level=debug", "  '  quoted '", "elogind.log_target=console", "\t", "  arg   with   space ", "3"));
}
