...
#if 0 /// elogind does not need to check for script files anywhere
...
#if 0 /// elogind does not fetch capeff from any process
TEST(capeff) {
...
#if 0 /// elogind does not load env file pairs anywhere
...
#if 0 /// elogind doesn not use search_and_fopen_nulstr() anywhere
