...
#include "varlink-io.elogind.h"
#include "varlink-io.elogind.Journal.h"
#include "varlink-io.elogind.ManagedOOM.h"
#include "varlink-io.elogind.Resolve.Monitor.h"
...
TEST(parse_format) {
        ...
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_UserDatabase);
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_Journal);
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_Resolve);
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_Resolve_Monitor);
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_ManagedOOM);
        print_separator();
        test_parse_format_one(&vl_interface_io_elogind_oom);
        print_separator();
        ...
        test_parse_format_one(&vl_interface_io_elogind_service);
        print_separator();
        print_separator();
...
TEST(interface_name_is_valid) {
        ...
        assert_se(varlink_idl_interface_name_is_valid("io.elogind.Foobar"));
}
