...
/*
  ...
  - Supports elogind-style automatic watchdog event generation
*/
...
#if 0 /// elogind supports systems, where missing _GNU_SOURCE does not guarantee that _POSIX_C_SOURCE is defined
