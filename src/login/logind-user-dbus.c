...
#if 0 /// elogind does not support systemd services and slices
...
#else // 0
        SD_BUS_PROPERTY("Service", "s", NULL, 0, SD_BUS_VTABLE_PROPERTY_CONST),
        SD_BUS_PROPERTY("Slice", "s", NULL, 0, SD_BUS_VTABLE_PROPERTY_CONST),
#endif // 0
