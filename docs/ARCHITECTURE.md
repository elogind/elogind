...
3. `elogind-run` and `systemctl set-property` do client-side parsing and translation into
...
`elogind-executor` binary, which will deserialize the configuration and apply
